...
<td>Traniee Domain</td></tr>
<tr><td> ${traniee.tranieeId} </td>
<td> ${traniee.tranieeName} </td>
<td> ${traniee.tranieeLocation} </td>
<td> ${traniee.tranieeDomain} </td></tr>
<tr align="right"><button type="submit">delete</button></tr>
</table>
</form>
</body>
</html>